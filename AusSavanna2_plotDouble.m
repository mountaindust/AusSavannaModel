...
function AusSavanna2_plotDouble(cont_model,discr_model)
...
plot(timecnt,Gam(day1:end),'Color',[0.53 0.81 0.98])
...
axnum = 3;
set(gcf,'CurrentAxes',h(axnum));
plot(timecnt,G(day1:end),'Color',[0.48 0.99 0])
%xlabel('Time (years)','FontSize',label_size)
xlim([skipshiftyears endYr+shift_years])
